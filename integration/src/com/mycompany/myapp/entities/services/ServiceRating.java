...
public class ServiceRating {
    ...
    public static ServiceRating getinstance(){
        ...
        String url = Statics.BASE_URL+"equipement/updaterating?idequipement="+e.getIdequipement()+"&iduser="+e.getIduser()+"&rating="+e.getRating();
       ...
       public ArrayList<Rating> parseallIDRatings(String jsonText){
            ...
            for(Map<String,Object> obj : list){
                ...
                if (obj.get("idequipement").toString() != null) {
                   a.setIdequipement((int)Float.parseFloat(obj.get("idequipement").toString()));
                }
    ...
    String url = Statics.BASE_URL + "equipement/check_rating?iduser=" + idUser;
        req.setUrl(url);
